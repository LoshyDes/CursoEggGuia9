...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
         ...
         * el mayor valor
         *
         * C) Método calcularPotencia para calcular la potencia del mayor valor
         * de la clase elevado al menor número. Previamente se deben redondear
         * ambos valores.
         *
         * D) Método calculaRaiz, para calcular la raíz cuadrada del menor de
        ...
        ParDeNumerosService.devolverMayor(pdn);
        ParDeNumerosService.devolverMenor(pdn);
        ParDeNumerosService.calcularPotencia(pdn);
        ParDeNumerosService.calculaRaiz(pdn);
